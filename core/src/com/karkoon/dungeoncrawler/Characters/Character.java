...
import com.karkoon.dungeoncrawler.Interfaces.Container;
 ...
 */
public abstract class Character implements Drawable, Updateable, TurnSupport, Container {
    ...
    private Vector3 moveRate = new Vector3(0, 0, 10);
    private Vector3 direction = new Vector3(0, 0, 90);
    private ArrayList<Item> items = new ArrayList<>(getMaxItems());
    ...
    private void setDecal(TextureRegion... textureRegions) {
        ...
        this.decal = AnimatedDecal.newAnimatedDecal(Dungeon.DungeonSection.WIDTH,
                Dungeon.DungeonSection.WIDTH, new Animation(1, textureRegions), true);
    ...
    public void update(float delta) {
        float yHeight = Dungeon.DungeonSection.WIDTH / 2f;
    ...
    protected void attack(Character object) {
