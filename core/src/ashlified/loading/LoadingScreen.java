...
import ashlified.loading.assetmanagerloaders.*;
...
public class LoadingScreen extends ScreenAdapter {
    ...
    private void setCustomLoaders() {
        ...
        assetManager.setLoader(BlueprintListLoader.BlueprintList.class, new BlueprintListLoader<>(new InternalFileHandleResolver(), EnemyNPCEntityConfigurer.EnemyNpcBlueprint.class));
