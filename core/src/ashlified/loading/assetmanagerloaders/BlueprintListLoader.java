...
public class BlueprintListLoader<T> extends AsynchronousAssetLoader<BlueprintListLoader.BlueprintList<T>, BlueprintListLoader.BlueprintListLoaderParameter<T>> {
    ...
    public static class BlueprintListLoaderParameter<T> extends AssetLoaderParameters<BlueprintList<T>> {
        Class<T> tClass;
